...
COPY web/login.html web/user.html web/admin.html web/favicon.ico web/VERSION cli/banip cli/userctl cli/adminctl cli/debug config/admin_config.example.json config/filter_rules.json bin/N_m3u8DL-RE /home/downloader/
